...
import { user, datePresets, operatingContext } from "../../data/dashboardData";
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div className="relative" ref={ctxRef}>
          ...
          >
            ...
            <span className="hidden sm:inline">{operatingContext.company} · {operatingContext.branch}</span>
            <span className="sm:hidden">{operatingContext.branch}</span>
